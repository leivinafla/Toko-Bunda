            ...
            <div class="job_card">
                <div class="">
                    ...
                    <table class="table1">
                        ...
                        $data = mysqli_query($koneksi, "SELECT produk_bunda.*, karyawan_bunda.username 
                            FROM produk_bunda
                            INNER JOIN karyawan_bunda ON produk_bunda.id_karyawan = karyawan_bunda.id_karyawan
                            ORDER BY produk_bunda.id_produk ASC LIMIT $halaman_awal, $batas");

                        $data_page = mysqli_query($koneksi, "SELECT * from produk_bunda");
                        $jumlah_data = mysqli_num_rows($data_page);
                        $total_halaman = ceil($jumlah_data / $batas);
                        $data_page = mysqli_query($koneksi, "SELECT * from produk_bunda limit $halaman_awal, $batas");
                        ...
                        while ($d = mysqli_fetch_array($data)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $d['tanggal_kadarluasa']; ?></td>
